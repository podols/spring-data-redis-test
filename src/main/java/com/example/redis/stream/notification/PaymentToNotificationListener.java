package com.example.redis.stream.notification;
...
@Component
public class PaymentToNotificationListener implements StreamListener<String, MapRecord<String, String, String>> {
